...
export default function InterviewsPhase({ projectId, interviews, isEditor, onRefresh }: Props) {
  ...
  async function deleteInterview(id: string) {
    if (!confirm('Delete this interview? Notes linked to it will be unlinked.')) return
            ...
            >
              ...
              {isEditor && (
                <button
                  ...
                  className="text-gray-300 hover:text-red-500 text-xl leading-none flex-shrink-0 mt-0.5"
